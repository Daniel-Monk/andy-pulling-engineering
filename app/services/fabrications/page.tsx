    ...
    <>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {items.map((item) => (
            <div key={item.name} className="bg-gray-900 border border-gray-800 rounded-xl p-5">
              <div className="w-2 h-2 bg-teal-400 rounded-full mb-3" />
              <h2 className="text-white font-bold text-base mb-2">{item.name}</h2>
      ...
      <section className="bg-gray-900 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl font-black text-white mb-8">Fabrication Gallery</h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="bg-teal-500 rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl font-black text-gray-900 mb-2">Got a fabrication requirement?</h2>
            <p className="text-teal-900 text-sm">Large or small — give Andy a call to discuss what you need.</p>
          </div>
          <Link href="/contact" className="flex-shrink-0 bg-gray-900 hover:bg-gray-800 text-white font-bold px-8 py-3 rounded-lg transition-colors text-sm">
            Get in Touch
          </Link>
        </div>
      </section>
