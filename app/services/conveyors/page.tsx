    ...
    <>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {types.map((t) => (
            <div key={t.name} className="bg-white border border-gray-200 rounded-xl p-6 hover:border-teal-400 hover:shadow-sm transition-all">
              <div className="w-2 h-2 bg-teal-500 rounded-full mb-4" />
              <h2 className="text-gray-900 font-bold text-lg mb-2">{t.name}</h2>
      ...
      <section className="bg-gray-50 border-y border-gray-200 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl font-black text-gray-900 mb-8">Conveyor Gallery</h2>
